...
function calculateSum() {
  ...
  // selectors
    ...
    const websiteCart = document.querySelector('#calculator-form-imput-card input:checked');
    const websiteReception = document.querySelector('#calculator-form-imput-reception input:checked');
...
function renderSum(sum) {
  const constElement = document.querySelector('.money');

  constElement.textContent = 'Calculating...';
  setTimeout(function(){
  constElement.textContent = sum + '$';
  },1000);
